...
<script type="text/javascript" src="http://i.huya.com/base/js/udbUtils.js"></script>
<link rel="stylesheet" href="http://assets.dwstatic.com/b=lego/1.0.0/css&f=mod.tips.css">
 <script src="http://assets.dwstatic.com/b=project/yytv/center/2.4/js&f=lego.popupbox.js"></script>
<link href="http://i.huya.com/main/statics/css/captcha.css" rel="stylesheet">
<link href="http://a.msstatic.com/huya/icenter/2.1/css/account_index.css?t=20160303v1" rel="stylesheet" />
<script type="text/javascript" src="http://i.huya.com/main/statics/js/captcha.js"></script>
<script>
...
<script type="text/javascript" src="http://i.huya.com/main/statics/js/account.js"></script>
<input type="hidden" name="greenbean_value" id="greenbean_value" value="" />
<input type="hidden" name="captcha_value" id="captcha_value" value="" />
<input type="hidden" name="exchangeType_value" id="exchangeType_value" value="1" />
...
<div class="admin-menu">
    ...
    <div class="main-col" id="propery-col">
        <div class="scroll-content">
                ...
                <div id="tab-click" class="mod-tab">
                  <div class="mod-tab-hd" style="border-bottom:1px solid #ccc;">
                      <ul class="mod-tab-trigger J_nav">
                          <li class="selected"><a href="http://i.huya.com/index.php?m=MyAccount&do=myAccount">我的财产</a></li>
                ...
                <div class="box-bd sum">
                    <div class="data-form mod-form-s">
                        <form action="" method="GET" name="captcha_form">
                    <label for="catpcha" style="width:190px;">请输入右图的验证码查询：</label>
                    <input type="text" name="captchaValue" />
                    <input type="hidden" id="captcha_id" name="captchaId" value="" />
                    <input type="hidden" name="m" value="MyAccount" />
                    <input type="hidden" name="do" value="myAccountByCaptcha" />
                    <img src="" id="captcha_pic"/>
                            <a href="javascript:;" id="change_one" style="color:#f80;margin-left: 5px;text-decoration:underline;">看不清楚</a>
    ...
    <div class="mod-tips-s2" id="detail_dialog" style="display:none">
        <div class="mod-tips-content" style="padding: 15px; border: 3px solid #c7c7c7;">
            <b>月结金元宝收入：</b>
            <p>
                当月每天礼物价值乘以当天频道分成比例，再乘以当月分成等级，
                加上守护收入就是月结金元宝数量。
            </p>
            <br>
            <b>时间安排：</b>
            <p>
                每月3日显示上月的月结金元宝收入，4日冻结当前金元宝并开始兑换成佣金，本流程会在2至3天内完成，完成兑换后就可以提现了。
            </p>
        </div>
...
</html>    <script type="text/javascript" src="http://a.msstatic.com/huya/icenter/2.5/js/account_index.js?t=20160303v1"></script>
