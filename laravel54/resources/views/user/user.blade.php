<html><head>
        ...
        <script src="//hm.baidu.com/hm.js?9d483e9e48ba1faa0dfceaf6333de846"></script><script src="//hm.baidu.com/hm.js?51700b6c722f5bb4cf39906a596ea41f"></script><script type="text/javascript" src="http://i.huya.com/base/js/jquery-1.7.2.min.js"></script>
    ...
    <div class="duya-header-wrap clearfix">
        <div class="duya-header-bd clearfix">
            ...
            <div class="duya-header-control clearfix">
                ...
                <div class="hy-nav-right nav-subscribe success-login" style="display: block;">
                ...
                <div class="hy-nav-right nav-user success-login" style="display: block;">
                    <a class="nav-user-title" href="http://i.huya.com/" target="_blank">
                        <img id="login-userAvatar" src="//huyaimg.msstatic.com/avatar/1062/06/3db86c2307602bbaab2f49bb4b819e_180_135.jpg" alt="头像">
                        <span id="login-username" title="Well.">Well.</span>
                        <i></i>
            ...
            <div class="duya-header-tips">
                ...
                <div id="refresh-wrap">
                    ...
                    <h6><input id="checkTips" type="checkbox"><label for="checkTips">今天内不提醒</label></h6>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="main-col">
            <div class="scroll-content">
                <div class="mod mod-user-center">
                    <img style="width:120px;height:120px;cursor:default;" class="user_icon" src="http://huyaimg.msstatic.com/avatar/1062/06/3db86c2307602bbaab2f49bb4b819e_180_135.jpg" alt="头像">
                    ...
                    <div class="user_info">
                        <h2 style="font-size: 25px;" class="uesr_n">Well.</h2>
                                                    <span class="user_sex user_sex-male"></span>
                                                
                        <!-- <p class="yy_num"><span>YY:</span><span id="YY">2094246914</span></p> -->
                                                <!-- 第三方登陆，昵称同步 -->
                        ...
                        <div class="detail table-badge" id="grow_level">
                            <span>LV1</span>
                            <span class="contact">
                                <span class="number">67/200</span>
                                <span class="part" style="width:33.5%;"></span>
                                <span class="grow_msg" style="top:-32px;left:0px;">
                                                                        <span class="grow_msg_span">今日获得<span class="num">0</span>点经验值，升级还需<span class="num">133</span>点</span>
                                                                        <i class="up_arrows"></i>
                                </span>
                            </span>
                            <span>LV2</span>
                        ...
                        <ul id="my_estate">
                                    ...
                                    <span class="tool-info">
                                        <i class="num" style="min-width:28px;">250</i>
                                                                                    <span class="hidden tool_msg">
                                                <i class="up_arrows"></i>
                                                <span class="tool_msg_span">银豆：250</span>
                                            </span>
                                                                                <i class="line"></i>
                                    </span>
                                </li>
            ...
            <div class="mod mod-basic" id="account_num">
                ...
                <div class="account_num_list" id="phone">
                    ...
                    <div class="msg">
                        ...
                        <p class="msg_2">已绑定：<span class="mobile num">182******00</span></p>
                    </div>
                ...
                <div class="account_num_list">
                    ...
                    <div class="msg">
                        ...
                        <p class="msg_2">建议定期修改密码，保证账号安全</p>
                                        ...
                                        <a class="result" href="javascript:void(0);" id="thirdLoginPassword" data-logintype="qq" data-userinfo="1841671653"></a>
                        <!-- 第三方登陆修改密码iframe -->
            ...
            <div class="cont cont-add">
                <form class="form content_span" action="about:blank" method="post" autocomplete="on" novalidate="" accept-charset="utf-8">
                    <div class="form-group">
                        ...
                        <input class="num-input" id="channelId_input" value="" disabled="" type="text">
                    </div>
                    <div class="form-group">
...
<!-- 第三方登陆修改密码 -->
    <script src="//a.msstatic.com/huya/common/footer.js"></script><div class="huya-footer">
    ...
    <div class="huya-footer__bd">
        <div class="huya-footer__nav">
            ...
            <p>
                ...
                <span><img src="//a.msstatic.com/huya/main/assets/img/j.gif" alt="">粤公网安备44011302000242号 </span>|
        ...
        <div class="huya-footer__hy-logo">
            <img src="//a.msstatic.com/huya/main/img/hy-logo.png" width="322" height="46">
            <a target="_blank" id="_pingansec_bottomimagesmall_brand" href="http://si.trustutn.org/info?sn=950170109026610628628&amp;certType=1"><img src="//a.msstatic.com/huya/main/img/brand_bottom_small.jpg"></a>
            <a href="https://credit.szfw.org/CX20170721035218030329.html" target="_blank"><img src="//a.msstatic.com/huya/main/assets/img/sf.png"></a>
            <a href="https://credit.szfw.org/CX20170721035218020978.html" target="_blank"><img src="//a.msstatic.com/huya/main/assets/img/silver.jpg"></a>
        </div>
    </div>
</div>
