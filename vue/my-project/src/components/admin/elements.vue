                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-4 center">
                        ...
                        <canvas width="93" height="93" style="width: 75px; height: 75px;"></canvas></div>
                    ...
                    <h3 class="row header smaller lighter orange">
                      ...
                      <span class="col-sm-4">
                        <label class="pull-right inline">
                          ...
                          <input id="gritter-light" checked="" class="ace ace-switch ace-switch-5" type="checkbox">
                          <span class="lbl"></span>
                        </label>
                      </span><!-- /span -->
                    </h3>
                      ...
                      <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" id="spinner-opts">
                          <label>
                            ...
                            <input class="hidden" name="lines" data-min="5" data-max="16" data-step="2" value="12" style="display: none;" type="text"><span class="ui-slider-small inline ui-slider- ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" style="width: 125px;" aria-disabled="false"><div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min" style="width: 72.7273%;"></div><a class="ui-slider-handle ui-state-default ui-corner-all" href="#" style="left: 72.7273%;"></a></span>
                          </label>

                          <label>
                            <small class="lighter" style="display: inline-block; width: 60px;">Length:</small>

                            <input class="hidden" name="length" data-min="0" data-max="30" value="7" style="display: none;" type="text"><span class="ui-slider-small inline ui-slider-green ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" style="width: 125px;" aria-disabled="false"><div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min" style="width: 23.3333%;"></div><a class="ui-slider-handle ui-state-default ui-corner-all" href="#" style="left: 23.3333%;"></a></span>
                          </label>

                          <label>
                            <small class="lighter" style="display: inline-block; width: 60px;">Width:</small>

                            <input class="hidden" name="width" data-min="2" data-max="20" value="4" style="display: none;" type="text"><span class="ui-slider-small inline ui-slider-red ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" style="width: 125px;" aria-disabled="false"><div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min" style="width: 11.1111%;"></div><a class="ui-slider-handle ui-state-default ui-corner-all" href="#" style="left: 11.1111%;"></a></span>
                          </label>

                          <label>
                            <small class="lighter" style="display: inline-block; width: 60px;">Radius:</small>

                            <input class="hidden" name="radius" data-min="0" data-max="40" value="10" style="display: none;" type="text"><span class="ui-slider-small inline ui-slider-purple ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" style="width: 125px;" aria-disabled="false"><div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min" style="width: 25%;"></div><a class="ui-slider-handle ui-state-default ui-corner-all" href="#" style="left: 25%;"></a></span>
                          </label>

                          <label>
                            <small class="lighter" style="display: inline-block; width: 60px;">Corners:</small>

                            <input class="hidden" name="corners" data-min="0" data-max="1" data-step="0.1" value="1" style="display: none;" type="text"><span class="ui-slider-small inline ui-slider-orange ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" style="width: 125px;" aria-disabled="false"><div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min" style="width: 100%;"></div><a class="ui-slider-handle ui-state-default ui-corner-all" href="#" style="left: 100%;"></a></span>
                          </label>

                          <label>
                            <small class="lighter" style="display: inline-block; width: 60px;">Rotate:</small>

                            <input class="hidden" name="rotate" data-min="0" data-max="90" value="0" style="display: none;" type="text"><span class="ui-slider-small inline ui-slider-dark ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" style="width: 125px;" aria-disabled="false"><div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min" style="width: 0%;"></div><a class="ui-slider-handle ui-state-default ui-corner-all" href="#" style="left: 0%;"></a></span>
                          </label>

                          <label>
                            <small class="lighter" style="display: inline-block; width: 60px;">Trail:</small>

                            <input class="hidden" name="trail" data-min="10" data-max="100" value="60" style="display: none;" type="text"><span class="ui-slider-small inline ui-slider- ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" style="width: 125px;" aria-disabled="false"><div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min" style="width: 55.5556%;"></div><a class="ui-slider-handle ui-state-default ui-corner-all" href="#" style="left: 55.5556%;"></a></span>
                          </label>

                          <label>
                            <small class="lighter" style="display: inline-block; width: 60px;">Speed:</small>

                            <input class="hidden" name="speed" data-min="0.5" data-max="2.2" data-step="0.1" value="1" style="display: none;" type="text"><span class="ui-slider-small inline ui-slider-green ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" style="width: 125px;" aria-disabled="false"><div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min" style="width: 50%;"></div><a class="ui-slider-handle ui-state-default ui-corner-all" href="#" style="left: 50%;"></a></span>
                          </label>
                        </form>
                      </div><!-- /row -->
                    </div><!-- /row -->
                    ...
                    <h3 class="row header smaller lighter blue">
                      ...
                      <span class="col-sm-5">
                        <label class="pull-right inline">
                          ...
                          <input id="id-pills-stacked" class="ace ace-switch ace-switch-5" type="checkbox">
                          <span class="lbl"></span>
                        </label>
                      </span><!-- /span -->
                    </h3>
